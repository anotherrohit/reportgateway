...
public class UserJson
{
	 ...
	 *
	 */
	@JsonProperty("spegisam")
	private String spegisam;
	@JsonProperty("spegpmstipaccess")
	private String spegpmstipaccess;
	@JsonProperty("speNewAttribute")
	private String speNewAttribute;
	@JsonProperty("speEmailActiveFlag")
	private String speEmailActiveFlag;
	@JsonProperty("SelfServicelocUpdtDt")
	private String SelfServicelocUpdtDt;
	@JsonProperty("speMacUser")
	private String speMacUser;
	...
	@JsonProperty("spespheconnectaccess")
	...
	private String speacsproductionl ;
	 ...
	 @JsonProperty("speacsproductionlwired")
	...
	public synchronized final String getSpegisam() {
		return spegisam;
	}

	public synchronized final void setSpegisam(String spegisam) {
		this.spegisam = spegisam;
	}

	public synchronized final String getSpegpmstipaccess() {
		return spegpmstipaccess;
	}

	public synchronized final void setSpegpmstipaccess(String spegpmstipaccess) {
		this.spegpmstipaccess = spegpmstipaccess;
	}

	public synchronized final String getSpeNewAttribute() {
		return speNewAttribute;
	}

	public synchronized final void setSpeNewAttribute(String speNewAttribute) {
		this.speNewAttribute = speNewAttribute;
	}

	public synchronized final String getSpeEmailActiveFlag() {
		return speEmailActiveFlag;
	}

	public synchronized final void setSpeEmailActiveFlag(String speEmailActiveFlag) {
		this.speEmailActiveFlag = speEmailActiveFlag;
	}

	public synchronized final String getSelfServicelocUpdtDt() {
		return SelfServicelocUpdtDt;
	}

	public synchronized final void setSelfServicelocUpdtDt(String selfServicelocUpdtDt) {
		SelfServicelocUpdtDt = selfServicelocUpdtDt;
	}

	public synchronized final String getSpeMacUser() {
		return speMacUser;
	}

	public synchronized final void setSpeMacUser(String speMacUser) {
		this.speMacUser = speMacUser;
	}
	...
	public String toString()
	{
		...
		if (spegisam != null)
		{
			builder.append("spegisam=");
			builder.append(spegisam);
			builder.append(", ");
		}
		if (spegpmstipaccess != null)
		{
			builder.append("spegpmstipaccess=");
			builder.append(spegpmstipaccess);
			builder.append(", ");
		}
		if (speNewAttribute != null)
		{
			builder.append("speNewAttribute=");
			builder.append(speNewAttribute);
			builder.append(", ");
		}
		if (speEmailActiveFlag != null)
		{
			builder.append("speEmailActiveFlag=");
			builder.append(speEmailActiveFlag);
			builder.append(", ");
		}
		if (SelfServicelocUpdtDt != null)
		{
			builder.append("SelfServicelocUpdtDt=");
			builder.append(SelfServicelocUpdtDt);
			builder.append(", ");
		}
		if (speMacUser != null)
		{
			builder.append("speMacUser=");
			builder.append(speMacUser);
			builder.append(", ");
		}
